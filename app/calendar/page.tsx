      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 mb-3">
        ...
        <div className="flex gap-1 items-center flex-wrap">
          <button
            ...
            className="text-xs sm:text-sm px-2.5 sm:px-2 py-1.5 sm:py-1 border border-gray-300 rounded hover:bg-gray-50 touch-target"
          ...
          {yearsWithEntries.length > 0 && (
            <select
              ...
              className="text-xs sm:text-sm px-2 py-1.5 sm:py-1 border border-gray-300 rounded bg-white ml-1 sm:ml-2"
            >
      ...
      <div className="bg-gray-50 border border-gray-200 rounded p-2 sm:p-3 mb-3">
        <div className="mb-2 sm:mb-3">
          <select
            ...
            className="w-full text-sm sm:text-xs border border-gray-300 rounded px-2.5 sm:px-2 py-2 sm:py-1 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-3">
          <div className="bg-white rounded p-2 sm:p-3 border border-gray-200">
            <p className="text-xs text-gray-600 mb-1 sm:mb-0.5">Current Streak</p>
            <p className="text-base sm:text-lg font-bold text-blue-600">{currentStreak}</p>
          </div>
          <div className="bg-white rounded p-2 sm:p-3 border border-gray-200">
            <p className="text-xs text-gray-600 mb-1 sm:mb-0.5">Longest Streak</p>
            <p className="text-base sm:text-lg font-bold text-green-600">{longestStreak}</p>
          </div>
        </div>
      </div>
