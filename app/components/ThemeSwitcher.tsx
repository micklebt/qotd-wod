...
export default function ThemeSwitcher() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2 rounded-md border border-gray-300 dark:border-[#333333] bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-[#ffffff] hover:bg-gray-100 dark:hover:bg-[#1a1a1a] transition-colors"
