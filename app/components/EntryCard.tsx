...
export default function EntryCard({ entry }: { entry: Entry }) {
  return (
    <Link href={`/entries/${entry.id}`}>
      <div className="border border-black dark:border-[#333333] rounded p-3 sm:p-4 hover:bg-gray-100 dark:hover:bg-[#2a2a2a] cursor-pointer active:bg-gray-200 dark:active:bg-[#1a1a1a] transition-colors bg-white dark:bg-[#0a0a0a]">
