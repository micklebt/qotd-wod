...
import { getParticipantsAsync, preloadParticipants, type Participant as DbParticipant } from '@/lib/participants';
    ...
    <>
      {showComparison && existingEntry && (
        <DuplicateComparisonModal
          ...
          proposedParticipantId={selectedParticipant}
          proposedDefinition={definition}
          proposedPronunciation={pronunciation}
          proposedPartOfSpeech={partOfSpeech}
          proposedEtymology={etymology}
